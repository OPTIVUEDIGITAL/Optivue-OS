...
| Rahmel Dela Cruz | `production/assets/rahmel-dela-cruz.webp` | Human trust / operator identity | Owner-supplied portrait of Rahmel Dela Cruz, center-cropped from the committed source to a 4:5 880×1100 WebP for the About section. | Owner-controlled asset; explicit website-use instruction is present in chat. No separate formal release is recorded. | Committed and prepared for P4 |
